...
1. Modify the project structure to ROS Package

<img src="https://github.com/HongbiaoZ/autonomous_exploration_development_environment/blob/noetic/img/header.jpg" alt="Header" width="100%"/>
